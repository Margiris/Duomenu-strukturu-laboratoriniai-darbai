 ...
 * @author Margiris
 */
@SuppressWarnings({"WeakerAccess", "unused", "EqualsWhichDoesntCheckParameterClass", "unchecked"})
public class Smartphone implements KTUable {
    ...
    public Smartphone(String dataString) {
        parse(dataString);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(Manufacturer, CoreCount, CPUClockSpeed, RAMSize, StorageSize, BatterySize);
    }
