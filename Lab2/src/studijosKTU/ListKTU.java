...
public class ListKTU<E extends Comparable<E>>
    ...
    public boolean equals(Object o) {
        ListKTU<E> list1 = this;
        ListKTU<E> list2 = (ListKTU<E>) o;
        ...
        for (Node<E> e1 = first; e1 != null; e1 = e1.next) {
            for (Node<E> e2 = list2.first; e2 != null; e2 = e2.next) {
                if (!e1.equals(e2))
                    return false;
            }
        }
    ...
    /**
     * Removes last occurrence of the specified element
     *
     * @param o Element that needs to be removed
